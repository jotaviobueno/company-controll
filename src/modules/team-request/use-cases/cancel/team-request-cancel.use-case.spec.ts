...
import { TeamRequestCancelUseCase } from './team-request-cancel.use-case';

describe('TeamRequestCancelUseCase', () => {
  let usecase: TeamRequestCancelUseCase;
  ...
  beforeEach(async () => {
    ...
    usecase = moduleRef.get<TeamRequestCancelUseCase>(TeamRequestCancelUseCase);
  });
